<html>
    ...
    ?>
    <body>
        <h1 style="color:hotpink">Downloads</h1>
        ...
        <p><a href="<?php echo $path?>/downloads/mods-3.0.0-beta-3.zip">mods-3.0.0-beta-3.zip</a> (85mb)</p>
        <h3>Old Server</h3>
        ...
        <p><a href="<?php echo $path?>/">Back</a></p>
    </body>
</html>